...
<script type="module" src="/calc-new/js/main.js?v=2.5"></script>
        ...
        <div class="main-calc-select">
            <label class="main-calc-select__label">
                ...
                <span class="main-calc-select__btn">
                    <span class="main-calc-select__btn_title">物流</span>
                    <span class="main-calc-select__btn_subtitle">0,8$/公斤起</span>
                </span>
            </label>
            <label class="main-calc-select__label">
                <input class="main-calc-select__input" type="radio" value="calc-customs" name="calc-type">
                <span class="main-calc-select__btn">
                    <span class="main-calc-select__btn_title">报关</span>
                    <span class="main-calc-select__btn_subtitle">0.25$/斤起</span>
                </span>
            </label>
            <!-- <label class="main-calc-select__label">
        ...
        <div class="main-calc__wrapper">
                ...
                <div class="main-calc-first__block">
                    ...
                    <div class="main-calc-first__choose">
                        <h4 class="main-calc__title _small">
                            ...
                            <span class="main-calc__title_text">我要</span>
                        </h4>
                        <div class="main-calc-first__choose_block">
                            <label class="main-calc-radio">
                                <span class="main-calc-radio__title">只有运输</span>
                            ...
                            <label class="main-calc-radio">
                                <span class="main-calc-radio__title">采购并运输</span>
                                <input class="main-calc-radio__input" type="radio" name="delivery-option"
                                    value="delivery-and-pickup">
                                <span class="main-calc-radio__mark"></span>
                                <span class="calc-tooltip">
                                    <span class="calc-tooltip__title">购买货物</span>
                                    <span class="calc-tooltip__text">
                                        除了运输，我们还从俄罗斯工厂、供应商和网上平台购买货物。如果对购买货物感兴趣，请使用此设置。<a class="calc-tooltip__link"
                                            target="_blank"
                                            href="https://wisetao.com/from-china/transaction/full-deal/">了解更多</a>
                                    </span>
                                </span>
                            </label>
                        </div>
            ...
            <div class="main-calc__from-to">
                ...
                <div class="main-calc__from-to_from group-input">
                    <div class="group-input__title">从</div>
                    <div class="group-input__input">
                        <input type="text" name="from_where" placeholder="俄罗斯-莫斯科" disabled="">
                ...
                <div class="main-calc__from-to_to group-input">
                    <div class="group-input__title">到</div>
                    <div class="group-input__input">
                        <input type="text" name="from_to" placeholder="中国- 佛山" disabled="">
                        <svg class="group-input__input_svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="6" y="10" width="12" height="8" rx="2" fill="#91969b"></rect>
                            <path d="M9 10V9C9 7.34315 10.3431 6 12 6C13.6569 6 15 7.34315 15 9V10" stroke="#91969b"
                        ...
                        <div class="tooltip">
                            ...
                            <span class="calc-tooltip">
                                <span class="calc-tooltip__title">南大门</span>
                                <span class="calc-tooltip__text">
                                    货物仅配送至莫斯科“南大门”。到您所在城市的配送将通过俄罗斯的运输公司完成。
                                </span>
                            </span>
                        </div>
                    </div>
                ...
                <div class="main-calc__from-to_check">
                    <label class="main-calc-checkbox">
                        ...
                        <span class="main-calc-checkbox__title">保险</span>
                        <span class="calc-tooltip">
                            <span class="calc-tooltip__title">保险</span>
                            <span class="calc-tooltip__text">
                                打勾的话运费计算包括保险费。保险费用为货物价值的 2% + 运费
                            </span>
                        </span>
                    </label>
                ...
                <div class="main-calc__from-to_adress group-input">
                    <div class="group-input__title">收货地址</div>
                    <div class="group-input__input">
                ...
                <div class="main-calc__from-to_adress_check">
                    <label class="main-calc-checkbox">
                        ...
                        <span class="main-calc-checkbox__mark"></span>
                        <span class="main-calc-checkbox__title">地址细节</span>
                    </label>
                </div>
            </div>
            ...
            <div class="client-redeem-data hidden">
                <div class="main-calc-container data-redeem">
                    <h4 class="main-calc__title _small">
                        ...
                        <span class="calc-tooltip">
                            <span class="calc-tooltip__title">回购数据</span>
                            <span class="calc-tooltip__text">
                                我们的经理需要回购数据来进行详细计算。
                                请手动填写数据或上传Excel文件。
                            </span>
                    ...
                    <div class="main-calc-bordered" data-redeem="1">
                        ...
                        <div class="main-calc-buy-info">
                            <div class="main-calc-upload__block">
                                <div class="group-input__title">商品图片</div>
                            ...
                            <div class="main-calc-buy-info__form">
                                ...
                                <div class="group-input">
                                    <div class="group-input__title">商品名称</div>
                                    <div class="group-input__input">
                                ...
                                <!-- Цена -->
                                <div class="group-input">
                                    <div class="group-input__title">单价</div>
                                    <div class="group-input__input">
                                ...
                                <!-- Количество -->
                                <div class="group-input">
                                    <div class="group-input__title">商品数量</div>
                                ...
                                <!-- Размер -->
                                <div class="group-input">
                                    <div class="group-input__title">尺寸</div>
                                    <div class="group-input__input">
                                ...
                                <!-- Цвет -->
                                <div class="group-input">
                                    <div class="group-input__title">颜色</div>
                                    <div class="group-input__input">
                                ...
                                <!-- Ссылка -->
                                <div class="group-input">
                                    <div class="group-input__title">商品链接（网店）</div>
                                    <div class="group-input__input">
                                ...
                                <!-- Примечание -->
                                <div class="group-input">
                                    <div class="group-input__title">备注</div>
                                    <div class="group-input__input">
            ...
            <div class="main-calc-container сlient-data hidden">
                <h4 class="main-calc__title _small">
                    <span class="main-calc__title_icon"></span>
                    <span class="main-calc__title_text">请输入您的信息</span>
                </h4>
                <div class="main-client-requisites-parametr__main">
                    <div class="group-input">
                        <div class="group-input__title">您的姓名：</div>
                        <div class="group-input__input">
                    ...
                    <div class="group-input">
                        <div class="group-input__title">联系电话：</div>
                        <div class="group-input__input">
            ...
            <div class="main-calc-container white-cargo hidden">
                ...
                <h4 class="main-calc__title _small">
                    <span class="main-calc__title_icon"></span>
                    <span class="main-calc__title_text">海关商品编码</span>
                </h4>
                ...
                <div class="main-calc-bordered white-cargo__block">
                    ...
                    <div class="group-input tnved-input-block">
                        <div class="group-input__title">选择海关商品编码</div>
                        <div class="group-input__input">
                            <input type="text" name="tnved_input" class="tnved-input" required
                                placeholder="输入海关商品编码或名称" />
                            <span class="error-message"></span>
                            <div class="after-tnved">搜索中...</div>
                    ...
                    <div class="white-cargo__justinfo name-code-container hidden">
                        ...
                        <div class="group-input">
                            <div class="group-input__title">商品编码：</div>
                            <div class="group-input__input">
                        ...
                        <div class="group-input">
                            <div class="group-input__title">波兰税率：</div>
                            <div class="group-input__input">
                        ...
                        <div class="group-input">
                            <div class="group-input__title">增值税（默认）：</div>
                            <div class="group-input__input nds-block">
                                ...
                                <label class="main-calc-checkbox">
                                    ...
                                    <span class="main-calc-checkbox__mark"></span>
                                    <span class="main-calc-checkbox__title">请注明您的增值税（VAT）。</span>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="main-calc-container grey-cargo">
                <h4 class="main-calc__title _small">
                    <span class="main-calc__title_icon"></span>
                    <span class="main-calc__title_text label-text active">规格</span>
                </h4>
                <!--Параметры Груза-->
                <div class="main-calc-parametr">
                    <label class="switch-btn">
                        ...
                        <span class="switch-btn__text _first" id="text1">总重量和体积</span>
                        <span class="switch-btn__text _second" id="text2">按尺寸</span>
                    </label>
                </div>
                <!-- Калькулятор -->
                <div class="main-calc-bordered hidden active">
                    <div class="main-calc-parametr__main">
                        ...
                        <div id="calc-by-info" class="group-input hidden active">
                            <div class="group-input__title">总体积</div>
                            <div class="group-input__input">
                                <input type="text" name="total_volume" class="" value="" required="">
                                <span class="group-input__param">立方米</span>
                                <span class="error-message"></span>
                        ...
                        <div id="calc-by-custom" class="group-input calc-by-custom hidden">
                            <div class="group-input__title">尺寸（长 * 宽 * 高）厘米</div>
                            <div class="group-input__inputs volume">
                                ...
                                <div class="volume-total">
                                    <input type="text" name="total_volume_calculated" class="volume-total__result"
                                        readonly>
                                    <span class="volume-total__m3">立方米</span>
                                </div>
                                <span class="calculated-data hidden"></span>
                        ...
                        <!-- Общий вес -->
                        <div class="group-input">
                            <div class="group-input__title">总重量</div>
                            <div class="group-input__input">
                                <input type="text" name="total_weight" class="" value="" required>
                                <span class="group-input__param">公斤</span>
                                <span class="error-message"></span>
                                <span class="calculated-data hidden"></span>
                            </div>
                        </div>
                        ...
                        <!-- Кол-во мест -->
                        <div class="group-input">
                            <div class="group-input__title">总件数</div>
                            <div class="group-input-increment">
                                <span class="group-input-increment__minus initialized">-</span>
                        ...
                        <label class="main-calc-checkbox _sameValue hidden js-quantity-checkbox">
                            ...
                            <span class="main-calc-checkbox__mark"></span>
                            <span class="main-calc-checkbox__title">所有位置的尺寸和重量都相同。</span>
                        </label>

                        <!-- Общая стоимость -->
                        <div class="group-input">
                            <div class="group-input__title">总成本</div>
                            <div class="group-input__input">
                        ...
                        <div class="group-input js-calc-category">
                            <div class="group-input__title">货物种类</div>
                            <div class="group-input__input">
                                <div class="calc-select">
                                    <div class="calc-select__selected js-error-category">
                                        <span class="calc-select__selected_name">选择</span>
                                    ...
                                    <div class="calc-select__options">
                                        <label class="calc-select__label">
                                            ...
                                            <span class="calc-select__name">服装</span>
                                            <span class="tooltip">
                                                <span class="tooltip-icon">?</span>
                                                <span class="calc-tooltip">
                                                    <span class="calc-tooltip__title">服装</span>
                                                    <span
                                                        class="calc-tooltip__text">所有类型的服装，包括外套（夹克、大衣）、休闲服（T恤、衬衫）、商务服（西装、夹克）、晚装（连衣裙、西装）、运动服（短裤、运动服）、内衣、服装配饰。</span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="calc-select__label">
                                            <input type="radio" name="category" value="shoes"
                                                class="calc-select__input">
                                            <span class="calc-select__name">鞋</span>
                                            <span class="tooltip">
                                                <span class="tooltip-icon">?</span>
                                                <span class="calc-tooltip">
                                                    <span class="calc-tooltip__title">鞋</span>
                                                    <span
                                                        class="calc-tooltip__text">所有类型的成人和儿童鞋，包括运动鞋、休闲鞋（皮鞋、莫卡辛鞋）、季节鞋（靴子、凉鞋）、拖鞋、特殊类型的鞋类（橡胶靴、工作鞋）</span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="calc-select__label">
                                            <input type="radio" name="category" value="products"
                                                class="calc-select__input">
                                            <span class="calc-select__name">食品</span>
                                            <span class="tooltip">
                                                <span class="tooltip-icon">?</span>
                                                <span class="calc-tooltip">
                                                    <span class="calc-tooltip__title">食品</span>
                                                    <span
                                                        class="calc-tooltip__text">所有类型的食品，包括包装食品和罐装食品、饮料（水、果汁、酒）、杂货（谷物、意大利面）、乳制品（奶酪、酸奶）、预制食品、香料、糖果、坚果、零食。</span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="calc-select__label">
                                            <input type="radio" name="category" value="consumer_electronics"
                                                class="calc-select__input">
                                            <span class="calc-select__name">家用电器和电子产品</span>
                                            <span class="tooltip">
                                                <span class="tooltip-icon">?</span>
                                                <span class="calc-tooltip">
                                                    <span class="calc-tooltip__title">家用电器和电子产品</span>
                                                    <span class="calc-tooltip__text">大型家电：电视、冰箱、冰柜、洗衣机、空调、热水器。
                                                        <br> 小型家电：电动剃须刀、吸尘器、熨斗、微波炉、烤箱、吹风机、护理设备（电动牙刷、按摩器）。
                                                        <br>电子产品：打印机、游戏控制器、充电器、监控摄像头、电缆、电脑外设（鼠标、键盘）。
                                                        <br>工具：电动工具、汽车配件（充电器）。</span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="calc-select__label">
                                            ...
                                            <span class="calc-select__name">配件与护理</span>
                                            <span class="tooltip">
                                                <span class="tooltip-icon">?</span>
                                                <span class="calc-tooltip">
                                                    <span class="calc-tooltip__title">配件与护理</span>
                                                    <span class="calc-tooltip__text">个人物品：包包、化妆品、香水、化妆用品、帽子。
                                                        <br> 家居用品：床上用品、毛巾、毯子。
                                                        <br>汽车用品：汽车零部件、汽车配件。
                                                        <br>五金制品：锁具、园艺工具。
                                                        <br>玩具：儿童玩具、宠物玩具。
                                                        <br>家居和厨房配件：熨衣板、布料、纽扣、脚垫。</span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="calc-select__label">
                                            ...
                                            <span class="calc-select__name">家用品和运动器材</span>
                                            <span class="tooltip">
                                                <span class="tooltip-icon">?</span>
                                                <span class="calc-tooltip">
                                                    <span class="calc-tooltip__title">家用品和运动器材</span>
                                                    <span
                                                        class="calc-tooltip__text">家用品：灯具、家具、餐具、纺织品（桌布、毛巾）。浴室：拖把、挂钩、清洁用具。玩具：电动自行车、娃娃、儿童套装。建筑材料：网、角、维修用配件。运动：健身及瑜伽产品、防护装备。装饰：钟表、绘画、墙纸、花瓶。</span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="calc-select__label">
                                            <input class="calc-select__input" type="radio" name="category"
                                                value="accessory">
                                            <span class="calc-select__name">小件物品</span>
                                            <span class="tooltip">
                                                <span class="tooltip-icon">?</span>
                                                <span class="calc-tooltip">
                                                    <span class="calc-tooltip__title">小件物品</span>
                                                    <span class="calc-tooltip__text">个人配饰：腰带、首饰。
                                                        <br> 家居用品：粘钩、手套、硅胶刷、家电耗材。
                                                        <br> 特殊商品：18+商品。</span>
                                                </span>
                                            </span>
                                        </label>
                        ...
                        <label class="main-calc-checkbox main-calc-checkbox__form js-calc-brand">
                            ...
                            <span class="main-calc-checkbox__mark"></span>
                            <span class="main-calc-checkbox__title">品牌</span>
                            <span class="calc-tooltip">
                                <span class="calc-tooltip__text">
                                    任何知名品牌的产品
                                </span>
            ...
            <div class="main-calc-packing">
                <div class="main-calc-packing__header js-add-class-packing">
                    <span class="main-calc-packing__header_title">包装 (额外服务)</span>
                    <span class="main-calc-packing__header_btn">
                        <span class="main-calc-packing__header_text">选择包装</span>
                ...
                <div class="main-calc-packing__content">
                    <label class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">基本包装 <br>（每件 2 $） </span>
                    </label>
                    <label class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">保护角落包装 <br>（每件 2 $）</span>
                    </label>
                    <label class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">木箱 <br>（30$/立方米）</span>
                    </label>
                    <label class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">三角形木框 <br>（35$/立方米）</span>
                    </label>
                    <label class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">木托盘 <br>（4$/个）</span>
                    </label>
                    <label class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">带防水包装的托盘 <br>(7,5$/立方米）</span>
                    </label>
                    <label class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">木箱 <br> 48$/立方米</span>
                    </label>
                    <div class="main-calc-packing__item">
                        ...
                        <span class="main-calc-packing__item_title">货物熏蒸 <br>（需单独确认）</span>
                    </div>
                    <div class="main-calc-packing__info">* 额外的包装会增加货物的重量</div>
                </div>
            </div>
            ...
            <div class="main-calc-parametr__main_btn">
                <button class="main-calc-button js-calculate-result" type="button"
                    data-scroll-to="js-calc-table">计算</button>
            </div>
            ...
            <div class="main-calc-result">
                <h4 class="main-calc__title _small label-text active">
                    <span class="main-calc__title_icon"></span>
                    <span class="main-calc__title_text label-text active">各类运输方式的费用</span>
                </h4>
                <div class="main-calc__subtitle">
                    对于5吨及以上的拼箱货物，运费将由经理单独计算，起价为0.25美元/公斤。
                    <!-- <button data-scroll-to="request">Оставить заявку</button> -->
                </div>

                <div class="main-calc-result__subtitle">请选择适合您的运输方式：</div>
                        ...
                        <div class="main-calc-result__cell price-cell">
                            ...
                            <div class="overflow-info">
                                <div class="main-calc-result-tooltip">
                                    ...
                                    <div class="main-calc-result-tooltip__info">* 额外的包装会增加货物的重量</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="main-calc-result__getblock">
                    <button class="main-calc-button js-get-pdf" disabled type="button">获取PDF格式的计算结果</button>
                </div>
