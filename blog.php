...
<? $APPLICATION->SetPageProperty("title", "博客"); ?>
<div class="content-page__page" itemscope itemtype="https://schema.org/Blog">
    <div class="content-page__title" data-aos="fade-up">
        <div class="content-page__title_block">
            <h1 class="content-page__title_text _text-left" itemprop="name">博客</h1>
            <div class="content-page__title_logo"><img
                    src="<?= SITE_TEMPLATE_PATH ?>/assets/images/logo.svg" alt=""></div>
            <div class="content-page__title_subtext" itemprop="description">关于与俄罗斯合作中最有趣和最重要的内容</div>
        </div>
    </div>
