...
<head>
    ...
    <meta name="description"
        content="赛德（Saide）自2013年开始提供全方位的中俄商务服务：包括货物运输、商品生产、商务考察、公司注册及会计支持等。我们致力于提供高质量的服务和可靠的合作伙伴关系。">
    <meta name="keywords"
        content="从俄罗斯到中国的批发供应, 从俄罗斯到中国的货物运输, 中国商品生产, 商务考察中国, 在中国注册公司, Saide, 批发运输, 物流中俄, 中俄电商平台, 中国生产质量控制">
    <!-- OG tags -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://saide-sd.cn">
    <meta property="og:title" content="赛德（Saide）- 自2013年开始中俄商务运营">
    <meta property="og:image"
        content="<?= SITE_TEMPLATE_PATH ?>/assets/images/logo.svg?v=<?= filemtime($_SERVER['DOCUMENT_ROOT'] . SITE_TEMPLATE_PATH . '/assets/images/logo.svg') ?>">
    <meta property="og:description" content="赛德（Saide）提供中俄全方位商务服务：货物运输、商品生产、商务考察、公司注册、会计支持等更多服务。">
    <meta property="og:site_name" content="赛德（Saide）- 自2013年开始中俄商务运营">
    <meta property="og:locale" content="zh_CN">

    <link rel="canonical" href="http://saide-sd.cn/">

    <!-- Favivon -->
    <link rel="shortcut icon"
        href="<?= SITE_TEMPLATE_PATH ?>/assets/images/logo.svg?v=<?= filemtime($_SERVER['DOCUMENT_ROOT'] . SITE_TEMPLATE_PATH . '/assets/images/logo.svg') ?>"
        type="image/x-icon">
    <!-- Apple Touch Icon -->
...
<body>
    ...
    <div id="preloader">
        <dotlottie-player style="width: 120px;height: 120px;"
            src="<?= SITE_TEMPLATE_PATH ?>/assets/js/preloader.json?v=<?= filemtime($_SERVER['DOCUMENT_ROOT'] . SITE_TEMPLATE_PATH . '/assets/js/preloader.json') ?>"
                    ...
                    <div class="main-select__logo">
                        ...
                        <div class="main-select__logo_wrapper scale-up-center-nt-500">
                            <img class="main-select__logo_img"
                                src="<?= SITE_TEMPLATE_PATH ?>/assets/images/logo.svg?v=<?= filemtime($_SERVER['DOCUMENT_ROOT'] . SITE_TEMPLATE_PATH . '/assets/images/logo.svg') ?>"
                                alt="">
                            <div class="main-select__logo_text">自 2013 运营 </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header__block">
                    <a href="#" class="header__logo js-go-index">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/logo.svg?v=<?= filemtime($_SERVER['DOCUMENT_ROOT'] . SITE_TEMPLATE_PATH . '/assets/images/logo.svg') ?>"
                            alt="logo">
                    </a>
            ...
            <div class="container">
                <div class="main-menu__block">
                    ...
                    <button class="mobile-back mobile-back-1">
                        ...
                        <span class="mobile-back__text">返回</span>
                    </button>
                    ...
                    <button class="js-go-index menu-back-btn"><span> &lt; </span> <span>从俄罗斯</span></button>
        ...
        <div class="main-menu">
            <div class="container">
                <div class="main-menu__block">
                    ...
                    <button class="js-go-index menu-back-btn"><span> &lt; </span> <span>到俄罗斯</span></button>
                </div>
            </div>
        </div>
                        ...
                        <div class="main-wall__heading">
                            <div class="main-wall__heading_block">
                                <h1 class="main-wall__heading_h1">
                                    <span class="main-wall__heading_first">货物运输</span>
                                    <? $from = $_GET['direct-china'] == 'from-china' ? '从俄罗斯' : '到俄罗斯'; ?>
                                    <? $calc = $_GET['direct-china'] == 'from-china' ? '计算费用' : ''; ?>
                                    <span class="main-wall__heading_second"><?= $from ?></span>
                                </h1>
                                <div class="main-wall__heading_text">
                                    <span>航空 / 汽运 / 铁路 / 海运</span>
                                    <span><?= $calc ?></span>
                            ...
                            <div class="page-menu__block active">
                                <div class="page-menu__dot">
                                    <div class="page-menu__dot_block">
                                        ...
                                        <span class="page-menu__dot_text">目录</span>
                                    </div>
                                </div>
