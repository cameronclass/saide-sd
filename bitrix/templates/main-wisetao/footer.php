    ...
    <div class="container-fluid" data-aos="fade-up">
        <div class="footer__block container">
            <div class="footer__logo">
                <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/logo.svg?v=1.2" alt="">
            </div>
            <div class="footer__menu">
                <div class="footer__menu_block">
                    <div class="footer__menu_title">从俄罗斯</div>
                    <?
                ...
                <div class="footer__menu_block">
                    <div class="footer__menu_title">到俄罗斯</div>
                    <?
                        $APPLICATION->IncludeComponent(
                            "bitrix:news.list",
                            "footer_menu",
                ...
                <div class="footer__menu_block">
                    <div class="footer__menu_title"><a href="/">所有服务</a></div>
                    <?
                        $APPLICATION->IncludeComponent(
                            "bitrix:news.list",
                            "footer_menu",
            ...
            <div class="footer__contact">
                <div class="footer__qrcode_block">
                ...
                <div class="footer__code_block">
                    <div class="footer__code">黑公网安备23119102231224</div>
                    <a class="footer__code" href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/license.png" alt="">
                        <span>黑ICP备2023007577号</span>
                    </a>
                </div>

                <!--                <a class="btn-primary" href="mailto:zakaz@wisetao.com"-->
                <!--                    onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'E-mail_button'}); return true;">saide_guoji@yeah.net</a>-->
                <a class="footer__number" href="tel:+8617304560702"
                    onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'Tap_to_phone'}); return true;">+86
                    17304560702</a>
                <div class="footer__social">
                    <!--                    <a href="#" class="footer__social_link">-->
                    <!--                        <img src="--><?php //= SITE_TEMPLATE_PATH ?>
                    <!--/assets/images/soc-phone.svg" alt="">-->
                    <!--                    </a>-->
                    ...
                    <!--                        <img src="--><?php //= SITE_TEMPLATE_PATH ?>
                    <!--/assets/images/soc-vk.svg" alt="">-->
                    <!--                    </a>-->
                    <!--                    <a href="#" class="footer__social_link">-->
                    <!--                        <img src="--><?php //= SITE_TEMPLATE_PATH ?>
                    <!--/assets/images/soc-youtube.svg" alt="">-->
                    <!--                    </a>-->
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="block-cookie__block">
            <div class="block-cookie__content">
                <div class="block-cookie__title">确认 Cookie</div>
                <div class="block-cookie__text">本网站使用Cookie文件来存储数据。继续使用本网站，即表示您同意使用这些文件。</div>
            </div>
            <button class="calc-panel__link block-cookie__btn">我同意</button>
        </div>
    </div>
</div> -->
