...
<form name="iblock_add" data-aos="fade-up" method="post" class="review-ask__form" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
    ...
    <div class="review-ask__input">
        <input type="text" class="main-input" placeholder="称呼 *" name="PROPERTY[189][0]" required>
        ...
        <div class="review-form-lists" style="z-index: 2;">
            <div class="review-form-lists-dropdown">
                <div class="review-form-lists-dropdown-toggle" id="review-form-lists" data-typelist="评价主题: " data-input_name="PROPERTY[187][0]" data-input_name_additionaly="PROPERTY[NAME][0]" data-ajax_form_inc="<?=$_SESSION['ajax_form_inc']?>">
                    评价主题 *
                </div>
        ...
        <div class="review-form-lists">
            <div class="review-form-lists-dropdown">
                <div class="review-form-lists-dropdown-toggle" id="review-form-lists" data-typelist="服务类: " data-input_name="PROPERTY[188][0]" data-ajax_form_inc="<?=$_SESSION['ajax_form_inc']?>">
                    服务类 *
                </div>
                <ul class="review-form-lists-dropdown-list">
    ...
    <div style="color: green">
        <? if($arResult["MESSAGE"] != ''): ?>
            <span style="font-size: 14px; margin-top: 10px; display: block">您的评价已收到，将在管理员审核后发布。</span>
        <? endif; ?>
    </div>
    <div class="review-ask__button">
        <button type="submit" name="iblock_submit" class="main-btn" value="ОТПРАВИТЬ">发送</button>
    </div>
</form>
