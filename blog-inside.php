    ...
    <div class="blog-inside__panel">
        <div class="blog-inside-panel__elements" itemscope itemtype="https://schema.org/Blog">
            <div class="calc-panel" data-aos="fade-up">
                ...
                <div class="calc-panel__text">1分钟内自行计算费用并选择最适合的运发。</div>
                <a href="/<?= $_GET['direct-china'] ?>/logistic/" class="calc-panel__link">计算费用</a>
            </div>
<!--            <h3 class="blog-inside__panel_title" data-aos="fade-up" itemprop="name">相关文章</h3>-->
            <?
