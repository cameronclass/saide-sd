...
<script type="application/ld+json">
{
    ...
    "@type": "WebPage",
    "name": "<?= $title; ?>",
    "url": "https://saide-sd.cn<?= $page_url; ?>",
    "description": "Saide 提供与俄罗斯相关的全方位服务：从货物运输和商品生产到商务考察和会计支持。我们自2013年起致力于提供高质量的服务和可靠的合作伙伴关系。",
    "mainEntity": {
        "@type": "Service",
        "serviceType": "<?= $title; ?>",
        "provider": {
...
<div class="content-page__page">
    <?php
    $titleImage = isset($titleImage) ? $titleImage : null;
    $textLong = isset($textLong) ? $textLong : null;
    $title = isset($title) ? $title : '';

    $classes = ['content-page__title', 'content-page__title_marketing'];
    if ($titleImage) {
        $classes[] = 'content-page__title_second';
    }
    if ($textLong == '1') {
        $classes[] = 'content-page__title_long';
    }
    ?>
    <div class="<?= implode(' ', $classes); ?>" data-aos="fade-up">
        <h1 class="content-page__title_text"><?= $title; ?></h1>
        <?php if ($titleImage): ?>
        <div class="content-page__title_img">
            <img class="content-page__title_img_item" src="<?= $titleImage ?>"
                alt="<?= htmlspecialchars(mb_substr($title, 0, 100)) ?>">
        </div>
        <?php endif; ?>
    </div>
                    ...
                    <div class="blog-inside__panel">
                        <div class="blog-inside-panel__elements">
                            <div class="calc-panel" data-aos="fade-up">
                                <div class="calc-panel__title">运输成本计算机</div>
                                <div class="calc-panel__text">1分钟内自行计算费用并选择最适合的运发。
                                </div>
                                <a href="/<?= $_GET['direct-china'] ?>/logistic/" class="calc-panel__link"
                                    onclick="_tmr.push({ type: 'reachGoal', id: 3555455, goal: 'tap_to_calculator'}); return true;">计算费用</a>
                            </div>
                            <?
                            $sectionId = SectionTable::getList([
                                'filter' => [
            ...
            $templateIblockNames = [
                'first' => $_GET['name'] == 'full-deal' ?
                    [
                        ...
                        'title' => '<h2 class="group-title" data-aos="fade-up">' . '其他服务' . '</h2>',
                        'open' => '',
                        'close' => '<div class="d-flex justify-content-center mb-5" data-aos="fade-up">
                                        <a href="https://saide-sd.cn/from-china/logistic/" class="calc-btn">计算费用</a>
                                    </div>',
                    ]
                    : ($_GET['name'] != 'photo-video-report' &&
                        ...
                        [
                            ...
                            'IBLOCK_TYPE' => 'cases',
                            'title' => '<div class="group-title" data-aos="fade-up">成功的项目</div>',
                ...
                'second' => $_GET['name'] == 'full-deal' ?
                    ...
                    [
                        ...
                        'template' => 'marketing_services',
                        'IBLOCK_TYPE' => 'marketing',
                        'title' => '<h3 class="group-title" data-aos="fade-up">' . '其他服务' . '</h3>',
                        'open' => '',
                        'close' => '<div class="d-flex justify-content-center mb-5" data-aos="fade-up">
                                        <a href="https://saide-sd.cn/from-china/logistic/" class="calc-btn">计算费用</a>
                                    </div>',
